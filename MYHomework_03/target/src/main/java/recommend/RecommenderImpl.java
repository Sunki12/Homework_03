       ...
       /* for(int i=0;i<60;i++)
        {
        	for(int j=0;j<60;j++)
        	{
        		...
        		for(int n=0;n<20;n++)
        		{
        			molecular=molecular+matrix2[i][n]*matrix2[j][n];
        			denominator1=denominator1+matrix2[i][n]*matrix2[i][n];
        			denominator2=denominator2+matrix2[j][n]*matrix2[j][n];
        		}
        		double denominator=Math.sqrt(denominator2)*Math.sqrt(denominator1);
        		matrix[i][j]=molecular/denominator;
        	}
        }*/
        return matrix2;
    }
